				...
				success: function (data) {
					...
					if (data.length > 0) {
						...
						<table class="table table-bordered table-striped jambo_table">\
							<thead>\
								<tr class="headings">\
									<th class="column-title">BookingID </th>\
									<th class="column-title">Name </th>\
									<th class="column-title">CheckIN/Out </th>\
								</tr>\
							</thead>\
							<tbody id="tData">\
							</tbody>\
						...
						for (i = 0; i < data.length; i++) {
							...
							$('#tab_cal_event').append('<tr><td class="col-sm-5">&emsp;&emsp;' + data[i]._id + '</td><td "col-sm-3">&emsp;&emsp;' + data[i].cname + '&emsp;&emsp;</td><td "col-sm-3">' + dat + '</td></tr>');
						} */
					}
				}
			});
